...
function calc() {
  ...
  initLocalSettings('.calculating__choose_big div', 'calculating__choose-item_active'); // функция расчета суточной нормы калорий
  ...
  calcTotal(); // функция для получения значений пола и кф физической активности для расчета totalCalc
  ...
  getStaticInfo('.calculating__choose_big div', 'calculating__choose-item_active'); // функция для получения динамических данных из input
...
function slider({
  ...
  let slideIndex = 1;
  let offset = 0; // создание динамических элементов (точек) переключения слайдов (навигатор слайдов)
  ...
  const deleteNotDigits = str => +str.replace(/\D/g, ''); //  продолжение работы с функциональностью слайдера - задаем начальную нумерацию и настройки
...
function tabs(tabsParentSelector, tabsSelector, tabContentSelector, activeClass) {
  const tabsParent = document.querySelector(tabsParentSelector),
        ...
        tabContent = document.querySelectorAll(tabContentSelector); // функция скрытия контента
  ...
  hideTabContent();
  showTabContent(); // обработчик события клика по элементу (вид питания)
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "setZero": function() { return /* binding */ setZero; }
/* harmony export */ });
...
window.addEventListener('DOMContentLoaded', () => {
  const popupTimerId = setInterval(() => (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.openPopup)('.popup', popupTimerId), 50000);
  (0,_modules_tabs__WEBPACK_IMPORTED_MODULE_1__.default)('.tabheader__items', '.tabheader__item', '.tabcontent', 'tabheader__item_active');
  (0,_modules_modal__WEBPACK_IMPORTED_MODULE_2__.default)('[data-modal]', '.modal', popupTimerId);
  ...
  (0,_modules_forms__WEBPACK_IMPORTED_MODULE_5__.default)('form', popupTimerId);
